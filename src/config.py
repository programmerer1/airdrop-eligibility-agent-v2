...
EVM_CONTRACT_DATE_SCANNER_RUN_INTERVAL = int(os.getenv("EVM_CONTRACT_DATE_SCANNER_RUN_INTERVAL", 120))
...
EVM_CONTRACT_SOURCE_SCANNER_RUN_INTERVAL = int(os.getenv("EVM_CONTRACT_SOURCE_SCANNER_RUN_INTERVAL", 100))
